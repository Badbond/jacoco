...
public class CondyProbeArrayStrategyTest {
	...
	public void should_store_instance_using_condy_and_checkcast() {
		...
		assertEquals(
				"(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/Class;)[Ljava/math/BigInteger;",
		...
		assertEquals("[Ljava/math/BigInteger;", castInstruction.desc);
