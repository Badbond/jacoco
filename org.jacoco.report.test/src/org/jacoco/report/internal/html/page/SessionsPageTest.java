...
public class SessionsPageTest extends PageTestBase {
	...
	public void testExecutionDataContent() throws Exception {
		...
		data.add(new ExecutionData(0x1000, "ClassB", new long[0]));
		data.add(new ExecutionData(0x1001, "ClassC", new long[0]));
		data.add(new ExecutionData(0x1002, "ClassA", new long[0]));
